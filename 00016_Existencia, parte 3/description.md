Interesante lo que acaba de suceder, ¿no? Cuando hacemos una consulta como `llegaFacil(tomas, exactas)`, `llegaFacil/2` funciona, _pese_ a que en la tercera cláusula nunca dijimos _cuál_ es la zona. 
